...
--------------
        ...
        local power, powerDeficit                           = br.player.power.amount.runicPower, br.player.power.runicPower.deficit
...
--------------------
    ...
    -- Action List - Core rotation
        ...
        -- Remorseless Winter
            ...
            if (#enemies.yards8 >=2 or talent.gatheringStorms or forceAOE) and 
